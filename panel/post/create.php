<?php
     ...
     {    
          ...
          {
          $query = "INSERT INTO posts SET title = ?, cat_id = ?, body = ?, image = ?, created_by = ? ,  created_at = NOW() ;";
          $statement = $pdo->prepare($query);
          $statement->execute([$_POST['title'], $_POST['cat_id'], $_POST['body'], $image, $id]);
          }
          redirect('panel/post');
     }
            ...
            <section class="col-md-10 pt-3">
                ...
                <form action="<?= url('panel/post/create.php') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <section class="form-group">
                        ...
                        <textarea class="form-control" name="body" id="body" rows="5" placeholder="texto ..."></textarea>
                    </section>
                    <section class="form-group">
